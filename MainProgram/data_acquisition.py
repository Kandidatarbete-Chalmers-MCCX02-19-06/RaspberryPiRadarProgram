...
class DataAcquisition(threading.Thread):
    def __init__(self, list_of_variables_for_threads, bluetooth_server):
        ...
        self.config.gain = 1  # Gain between 0 and 1. Larger gain increase the SNR, but come at a cost
    ...
    def run(self):
        ...
        while self.go:
            ...
            if tracked_data is not None:
                ...
                highpass_filtered_data_RR = self.highpass_RR.filter(tracked_data["relative distance"]) #TODO: Ändra till highpass_filtered
