...
def main():
    ...
    p = os.popen('sudo /home/pi/Documents ls -ls')
    ...
    #     shell=True
    # )
    subprocess.Popen("./~/Documents/evk_service_linux_armv71_xc112/utils/acc_streaming_server_rpi_xc112_r2b_xr112_r2b_a111_r2c",shell=True)
