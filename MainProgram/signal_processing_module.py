...
class SignalProcessing:
    ...
    def heart_rate(self):  # MAIN for finding pulse
        ...
        while self.go:
            ...
            if self.initiate_write_heart_rate and time.time() - self.list_of_variables_for_threads["start_write_to_csv_time"] < 1*60:
    ...
    def smartFFT(self):  # "signal_in" is "fft_window"
        ...
        signal_in_fft = fft(self.fft_window, n=2*self.window_width)  # ,n=2*self.window_width)
