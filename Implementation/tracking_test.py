...
class Tracking:
    ...
    def tracking(self, data, data_idx):
        ...
        # After first seq continous tracking
            ...
            self.threshold = np.abs(self.data[int(self.I_peaks_filtered[0][self.data_idx])])*0.75         # determines the amplitude of the last tracked data for find_peaks function
